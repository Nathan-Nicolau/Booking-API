...
non-local guesses:
	 -javax/inject/reservadoComSucesso.
	 -javax/inject/reservadoComSucesso#
	 -javax/inject/reservadoComSucesso().
	 -model/data/EntidadeQuarto.reservadoComSucesso.
	 -model/data/EntidadeQuarto.reservadoComSucesso#
	 -model/data/EntidadeQuarto.reservadoComSucesso().
	 -dbConfig/profile/api/reservadoComSucesso.
	 -dbConfig/profile/api/reservadoComSucesso#
	 -dbConfig/profile/api/reservadoComSucesso().
	 -reservadoComSucesso.
	 -reservadoComSucesso#
	 -reservadoComSucesso().
	 -scala/Predef.reservadoComSucesso.
	 -scala/Predef.reservadoComSucesso#
	 -scala/Predef.reservadoComSucesso().
offset: 4580
...
class ReservaService @Inject()(dbConfigProvider: DatabaseConfigProvider)(implicit ec: ExecutionContext) {
  ...
  val queryReservasQuarto = ReservasQuarto.tabela.filter { reserva => 
    ...
    (reserva.dataFimReserva <= novaReserva.getDataFimReservaAjustada())}

  val reservasQuarto = Try(db.run(queryReservasQuarto)) match { 
    case Success(reservas) => { 
